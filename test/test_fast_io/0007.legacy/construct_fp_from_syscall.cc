    ...
    */
    ...
    println(
        ...
        ::fast_io::mnp::handlevw(
            static_cast<fast_io::win32_io_observer>(cf).handle)
        ...
        "zw HANDLE:",
        ::fast_io::mnp::handlevw(
            static_cast<fast_io::zw_io_observer>(cf).handle),
        "\n"
        "nt HANDLE:",
        ::fast_io::mnp::handlevw(
            static_cast<fast_io::nt_io_observer>(cf).handle)
#endif
#endif
    );
}
...
g++ -o construct_fp_from_syscall construct_fp_from_syscall.cc -Ofast -std=c++20
-s -flto -march=native -lntdll
