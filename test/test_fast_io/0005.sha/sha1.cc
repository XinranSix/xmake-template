...
/*
This is just for demo purpose. You should avoid sha1 in general because it is
insecure. fast_io's own implementation. No need to install anything. Probably
need -march=native to enable sha intrinsics
*/
...
int main(int argc, char **argv) {
    ...
    println(hash_digest(ctx), " *", os_c_str(argv[1]),
            "\nTransmitted:", transmitted, " bytes\tElapsed Time:",
